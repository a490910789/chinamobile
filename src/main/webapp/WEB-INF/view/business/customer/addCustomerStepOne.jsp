...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 5px;">
  <legend>新增客户step-1</legend>
</fieldset>
   <div style="position: relative;margin: 30px 100px">
	<form lay-filter="fm" class="layui-form layui-form-pane" action="${ctx}/customer/addCustomerCheckStepOne.action" method="post"
		id="fm">
		...
		<div class="layui-form-item">
			...
			<div style="text-align: left;margin-top: 30px">
				<!-- <input  class="layui-btn" type="submit" value="下一步" >  -->
